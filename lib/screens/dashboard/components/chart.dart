...
class Chart extends StatelessWidget {
  ...
  List<PieChartSectionData> _buildPieChartSelectionData(BuildContext context) {
    ...
    int cancelledOrder = context.dataProvider.calculateOrdersWithStatus(status: 'shipped');
    int shippedOrder = context.dataProvider.calculateOrdersWithStatus(status: 'delivered');
    int deliveredOrder = context.dataProvider.calculateOrdersWithStatus(status: 'cancelled');
